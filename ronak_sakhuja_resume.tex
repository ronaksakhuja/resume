...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Article.com}{Vancouver, Canada}
      {Software Engineer Part-Time}{Jan 2021 - Present}
      \resumeItemListStart
        \resumeItem{Fulfilment Logic}
          {Optimizing ETA logic in Java Spring Boot for fulfilling orders of article.com faster to customers.}
      \resumeItemListEnd
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Open Energy Platform}
          ...
          \\\textbullet
          { Building Azure OEP PaaS to enable Oil and Gas companies to use OSDU on Azure. Tech Stack : Sprint Boot, kubernetes and docker}
          \\\textbullet
          {Improved resiliency of microservices to handle failures across other services and infrastructure resources by using circuitbreakers, retries, timeouts and identifying and mitigating single points of failures.}
          \\\textbullet
          {Designed,built and integrated CI/CD pipelines for build test and release of nightly builds to dev test and prod environments.}
        ...
        {Microsoft Dynamics 365 is a cloud-based business applications platform that combines components of CRM and ERP with AI capabilities.}
          \newline
          \textbullet
          { Analysed,  identified and fixed issues with SLA Migration feature for 94\% customers before launch through proactive monitoring of logs.}
          \newline
          \textbullet
          { Built integrated test mechanism for SLA Migration and automated it with build pipeline.}
      \resumeItemListEnd
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Omnichannel Migration Framework}
          ...
          \newline
          {This automation reduced a PM's work from 10 hours to 10 minutes to setup an environment.}
      \resumeItemListEnd
